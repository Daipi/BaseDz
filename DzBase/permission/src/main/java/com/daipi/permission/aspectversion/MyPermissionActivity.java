...
// TODO 专门权限处理的Activity  空白的Activity
public class MyPermissionActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_permission); // 透明
        ...
        if (permissions == null && requestCode < 0 && iPermissionListener == null) {
            this.finish(); // 如果外界传递过来的 权限有问题，我会结束自己
            return;
        }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (PermissionUtils.requestPermissionSuccess(grantResults)) {
            iPermissionListener.ganted(); // 已经授权成功了  // 接口告知 AspectJ
        ...
        if (!PermissionUtils.shouldShowRequestPermissionRationale(this, permissions)) {
            // 用户拒绝，不再提醒
            iPermissionListener.denied();  // 接口告知 AspectJ
    ...
    public static void requestPermissionAction(Context context, String[] permissions,
        ...
        context.startActivity(intent); // 自己启动自己的Activity
    }
}
