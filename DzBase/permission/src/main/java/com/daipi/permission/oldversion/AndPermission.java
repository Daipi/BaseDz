...
public class AndPermission {
    ...
    SettingDialog defaultSettingDialog(@NonNull Activity activity, int requestCode) {
        return new SettingDialog(activity, (com.yanzhenjie.permission.SettingService) new SettingExecutor(new AppActivityTarget(activity), requestCode));
    }
    ...
    SettingDialog defaultSettingDialog(@NonNull Fragment fragment, int requestCode) {
        return new SettingDialog(fragment.getActivity(), (com.yanzhenjie.permission.SettingService) new SettingExecutor(new SupportFragmentTarget(fragment), requestCode));
    }
    ...
    SettingDialog defaultSettingDialog(@NonNull android.app.Fragment fragment, int requestCode) {
        return new SettingDialog(fragment.getActivity(), (com.yanzhenjie.permission.SettingService) new SettingExecutor(new AppFragmentTarget(fragment), requestCode));
    }
    ...
    SettingDialog defaultSettingDialog(@NonNull Context context) {
        return new SettingDialog(context, (com.yanzhenjie.permission.SettingService) new SettingExecutor(new ContextTarget(context), 0));
    }
