...
public class SettingDialog {
    ...
    private com.yanzhenjie.permission.SettingService mSettingService;

    SettingDialog(@NonNull Context context, @NonNull com.yanzhenjie.permission.SettingService settingService) {
