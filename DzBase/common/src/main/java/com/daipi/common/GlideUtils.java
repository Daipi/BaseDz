...
import com.daipi.base.utils.DisplayUtils;
...
public class GlideUtils {
    /*** 占位图 */
    public static int placeholderImage = R.mipmap.ic_user_default;
    /*** 错误图 */
    public static int errorImage =  R.mipmap.ic_user_default;
